...
export default function DonationRegistrationScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>고정 지출 등록</Text>
      </View>
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("DonationCalendar")}>
